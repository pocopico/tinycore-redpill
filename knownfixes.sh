...
function knownfixes() {
     ...
     *)
	 ...
	 ds920p)
          ...
          \
               7.1.0-42621)
			   cd redpill-load ; ./ext-manager.sh add https://github.com/jumkey/redpill-load/raw/develop/redpill-dtb/rpext-index.json
			   cd redpill-load ; ./ext-manager.sh _update_platform_exts ds920p_42218
